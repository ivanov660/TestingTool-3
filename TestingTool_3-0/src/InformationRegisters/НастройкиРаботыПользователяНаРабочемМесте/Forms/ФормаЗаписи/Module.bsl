...
Процедура ТекущиеПараметры(Команда)
	ТекущиеПараметрыНаСервере();
КонецПроцедуры

&НаСервере
Процедура ТекущиеПараметрыНаСервере()
	Запись.Пользователь = ПользователиВызовСервера.ТекущийПользователь();
	Запись.РабочееМесто = ПользователиВызовСервера.ТекущееРабочееМесто();
КонецПроцедуры
