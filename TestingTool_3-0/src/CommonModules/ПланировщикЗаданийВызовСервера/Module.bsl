...
Функция УдалитьЗначениеПеременной(Знач Задание,Знач ИмяПеременной,Знач Ключ=Неопределено) Экспорт
	Возврат ПланировщикЗаданийСервер.УдалитьЗначениеПеременной(Задание,ИмяПеременной,Ключ);
КонецФункции	
...
Функция УдалитьЗначениеПользовательскойПеременной(Знач Задание,Знач ИмяПеременной,Знач Ключ=Неопределено) Экспорт
	Возврат ПланировщикЗаданийСервер.УдалитьЗначениеПользовательскойПеременной(Задание,ИмяПеременной,Ключ);
КонецФункции	
...
Функция ПолучитьДанныеПодключенияПользователяПоКлючу(Знач Ключ,Знач ИмяПараметра=Неопределено) Экспорт
	Возврат ПланировщикЗаданийСервер.ПолучитьДанныеПодключенияПользователяПоКлючу(Ключ,ИмяПараметра);
КонецФункции	
