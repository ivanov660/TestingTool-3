...
Процедура ВыполнениеДействийЗаданийИзПуллаПоТипуЗапуститьПриложение(Знач ВыборкаДетальная) Экспорт 
	...
	Если СтруктураДействия.ИспользоватьШаблонКоманды=Истина Тогда
		мПараметры = новый Структура("Владелец,Действие,Проверка,ЗаданиеВладелец,ТестируемыйКлиент",ВыборкаДетальная.Задание,ВыборкаДетальная.Действие,ВыборкаДетальная.Проверка,ВыборкаДетальная.ЗаданиеВладелец,ВыборкаДетальная.ТестируемыйКлиент);
