...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СоответствиеНастроекПользователя = СценарноеТестированиеСервер.ПолучитьСоответствиеНастроекПользователя(ПользователиВызовСервера.ТекущийПользователь(),ПользователиВызовСервера.ТекущееРабочееМесто());
...
Процедура ОбновитьСостояниеПлагиновВообще()
	...
	Если ИскатьВКорнеGIT Тогда
		...
		СоответствиеНастроекПользователя = СценарноеТестированиеВызовСервера.ПолучитьСоответствиеНастроекПользователя(ПользователиВызовСервера.ТекущийПользователь(),ПользователиВызовСервера.ТекущееРабочееМесто());
		ПутьКаталогGIT = СоответствиеНастроекПользователя.Получить(ИмяКлюча);
