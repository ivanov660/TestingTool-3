...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(ТаблицаКоманд,
	                "Конструктор запуска External Automation UI",
					"ExternalAutomationUI_TaskBuilder",
					"ОткрытиеФормы",
					Истина,
					);
...
Функция ИнформацияПоИсторииИзменений()
	...
	| <li> Исполняемый файл с обвязкой должен находиться в каталоге путь GIT\ExternalAutomationUI\WinAutoamtionUI.exe. </li> 	
	| <hr />
