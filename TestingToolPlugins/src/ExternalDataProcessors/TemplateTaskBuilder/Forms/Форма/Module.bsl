...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИдентификаторКонструктора = "TemplateTaskBuilder";
...
Функция СоздатьНовоеЗаданиеНаСервере()
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации("TemplateTaskBuilder",УровеньЖурналаРегистрации.Ошибка,Неопределено,Неопределено,ТекстОшибки);
	КонецПопытки;
