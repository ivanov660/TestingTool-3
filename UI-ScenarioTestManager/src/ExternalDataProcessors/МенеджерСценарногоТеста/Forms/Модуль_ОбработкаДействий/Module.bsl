...
&НаКлиенте
Процедура мСценСкрипт_ПолучитьПредставлениеДанных(ТестовоеПриложение,ОписаниеОшибки,мПараметрыКлиент,ТекущаяПеременная,ПредставлениеДанных,ИмяПараметра,ЗначениеПараметра,ПараметрыСценария) Экспорт
...
&НаКлиенте
Процедура мСценСкрипт_СравнитьСПредставлениемДанных(ТестовоеПриложение,ОписаниеОшибки,мПараметрыКлиент,ТекущаяПеременная,ПредставлениеДанных,ПараметрыСценария,УсловиеСравнения="") Экспорт
...
&НаКлиенте
Функция мСценСкрипт_СравнитьСПредставлениемДанныхФрагмент(Знач УсловиеСравнения, ШаблонПроверки, ПроверяемыйТекст) Экспорт
...
&НаКлиенте
Процедура мСценСкрипт_ОбработатьУсловие(ТестовоеПриложение,ОписаниеОшибки, Узел, ИмяПараметра,ЗначениеПараметра,УсловиеСравнения, ПараметрыСценария, ОсуществитьПереходСТекущегоШага)
...
&НаКлиенте
Процедура мСценСкрипт_НайтиФорму(ТестовоеПриложение,ОписаниеОшибки,ТекущаяПеременная,РодительПеременная,Знач ЗаголовокОбъекта,ИспользоватьВариантыПоиска=Ложь) Экспорт 
