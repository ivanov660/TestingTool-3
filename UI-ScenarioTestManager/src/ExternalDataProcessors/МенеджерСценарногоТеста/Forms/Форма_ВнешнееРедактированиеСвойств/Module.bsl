...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ДействиеИзСценария="ИзПараметра1ВПараметр2" ИЛИ ДействиеИзСценария="Память" Тогда
...
Процедура ПриянтьИЗакрыть(Команда)
	...
	ИначеЕсли ДействиеИзСценария="Память" ИЛИ ДействиеИзСценария="ИзПараметра1ВПараметр2" ИЛИ ДействиеИзСценария="СравнитьСПредставлениемДанных" ИЛИ ДействиеИзСценария="ПроверкаНаличияЭлемента" Тогда
