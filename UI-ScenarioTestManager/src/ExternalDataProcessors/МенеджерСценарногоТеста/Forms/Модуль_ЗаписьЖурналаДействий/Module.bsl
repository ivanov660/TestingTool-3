...
&НаКлиенте
Процедура НачатьЗапись_AutomationUI_API(Знач PID=0,Знач НомерПорта=8080) Экспорт
	...
	СтруктураОтвета = Модуль_СервисныеФункции.ЗагрузитьФайлПоИнтернетАдресу("http://localhost:"+Формат(НомерПорта,"ЧГ=;")+"/rest.html");
...
&НаКлиенте
Процедура ПаузаЗапись_AutomationUI_API(Знач НомерПорта=8080) Экспорт
	
	ЗагрузитьБиблиотеки();
	
	СтруктураОтвета = Модуль_СервисныеФункции.ЗагрузитьФайлПоИнтернетАдресу("http://localhost:"+Формат(НомерПорта,"ЧГ=;")+"/rest.html?&Operation=record_pause&api=Automation UI");
...
&НаКлиенте
Функция ЗавершитьЗапись_AutomationUI_API(Знач НомерПорта=8080) Экспорт
	
	ЗагрузитьБиблиотеки();
	
	Текст = "";
	
	СтруктураОтвета = Модуль_СервисныеФункции.ЗагрузитьФайлПоИнтернетАдресу("http://localhost:"+Формат(НомерПорта,"ЧГ=;")+"/rest.html?&Operation=record_stop&api=Automation UI");
...
&НаКлиенте
Функция СписокПриложенийДляОтладки_AutomationUI_API(Знач НомерПорта=8080) Экспорт
	
	ЗагрузитьБиблиотеки();
	
	СтруктураОтвета = Неопределено;

	СтруктураОтвета = Модуль_СервисныеФункции.ЗагрузитьФайлПоИнтернетАдресу("http://localhost:"+Формат(НомерПорта,"ЧГ=;")+"/rest.html?&Operation=app_list");
...
&НаКлиенте
Процедура НачатьЗапись_Selenium_API(Знач НомерПорта=8080,Знач ИмяСессии="Selenium") Экспорт
...
&НаКлиенте
Процедура ПаузаЗапись_Selenium_API(Знач НомерПорта=8080,Знач ИмяСессии="Selenium") Экспорт
...
&НаКлиенте
Функция ЗавершитьЗапись_Selenium_API(Знач НомерПорта=8080,Знач ИмяСессии="Selenium") Экспорт
...
&НаКлиенте
Функция ЗапуститьБраузер_Selenium_API(Знач Браузер,Знач НомерПорта=8080,Знач ИмяСессии="Selenium") Экспорт
...
&НаКлиенте
Функция ЗакрытьБраузер_Selenium_API(Знач НомерПорта=8080,Знач ИмяСессии="Selenium") Экспорт
