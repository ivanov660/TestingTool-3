	...
	ИначеЕсли ТекущиеДанные.Действие="Команда" Тогда
		...
		ИначеЕсли Объект.ИспользуемыйAPI="AutomationUI" Тогда
			...
			ИначеЕсли НРЕГ(ТекущиеДанные.Команда)="send key" Тогда
				ТекстПодсказки = ТекстПодсказки+"<br /> <b>send key</b> - отправляет команду-текст на выбранном элементе. Чтобы отправить горячую клавишу F4 - введите '{F4}', Shift - '+', Alt - '%', Ctrl - '^'. Используйте перед этой операцией команду focus или click. Пример: Ctrl+F1 - '^+{F1}'";		
